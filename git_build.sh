...
function setRstate {
	...
	mv Network-Analytics-Procus-EPC/build/feature-release.xml Network-Analytics-Procus-EPC/build/feature-release.${rstate}.xml
...
function nexusDeploy {
	...
	ArtifactId=$module
	zipName=Network-Analytics-Procus-EPC
